...
public class GeneralConfig {
	...
	@Config(description = "Set to true to make the quark big worldgen features such as stone clusters or undergroundpackage vazkii.quark.base.handler;
...
public class GeneralConfig {
 ...
 biomes generate as spheres rather than unique shapes. It's faster, but won't look as cool")
	public static boolean useFastWorldgen = false;
